...
__all__ = ['RegionLoss', 'RegionLoss_new']
...
class RegionLoss_new(nn.modules.loss._Loss):
    """ Computes region loss from darknet network output and target annotation.
    ...
    def __build_targets_tensor(self, pred_boxes, ground_truth, nH, nW):
        ...
        for b in range(nB):
            ...
            iou_gt_pred = bbox_multi_ious2(gt, cur_pred_boxes)
            ...
            gt_wh = gt.clone()
            gt_wh[:, :2] = 0
            iou_gt_anchors = bbox_multi_ious2(gt_wh, anchors)
...
def bbox_multi_ious2(boxes1, boxes2):
