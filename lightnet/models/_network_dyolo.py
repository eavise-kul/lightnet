...
class DYolo(lnn.module.Lightnet):
    ...
    def __init__(self, num_classes=20, input_channels=3, anchors=[(5.2884, 6.9258), (12.771, 16.03776), (20.22348, 32.39568), (37.88448, 19.36212), (44.9456, 40.0284)]):
        super().__init__()
        ...
        layer_list = [
            ...
            OrderedDict([
                ('25_convbatch',    lnn.layer.Conv2dBatchReLU(512+512, 512, 1, 1, 0)),
                ('26_deconv',       nn.ConvTranspose2d(512, 512, 2, 2))
            ]),

            # Sequence 4 : input = sequence3 + sequence0
            OrderedDict([
                ('27_convbatch',    lnn.layer.Conv2dBatchReLU(512+256, 512, 1, 1, 0)),
